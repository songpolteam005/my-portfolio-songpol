  ...
  return (
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 antialiased font-sans selection:bg-indigo-500 selection:text-white">
      ...
      <main className="max-w-4xl mx-auto px-6 py-20 space-y-28">
        ...
        {/* 2. ABOUT SECTION - การ์ดสไตล์กระจกเงา (Glassmorphism) */}
        ...
        {/* 2.5 TECH STACK SECTION - เพิ่มเติมตามรูปภาพที่คุณอัปโหลด */}
        ...
        <section id="projects" className="scroll-mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <article className="group bg-slate-900/40 p-6 rounded-2xl border border-slate-900 shadow-md hover:shadow-xl hover:border-indigo-500/30 hover:bg-slate-900/80 transition-all duration-300 flex flex-col justify-between relative overflow-hidden">
              <div>
            ...
            <article className="group bg-slate-900/40 p-6 rounded-2xl border border-slate-900 shadow-md hover:shadow-xl hover:border-emerald-500/30 hover:bg-slate-900/80 transition-all duration-300 flex flex-col justify-between relative overflow-hidden">
              <div>
            ...
            <article className="group bg-slate-900/40 p-6 rounded-2xl border border-slate-900 shadow-md hover:shadow-xl hover:border-purple-500/30 hover:bg-slate-900/80 transition-all duration-300 flex flex-col justify-between relative overflow-hidden">
              <div>
        ...
        <section id="contact" className="relative overflow-hidden bg-gradient-to-r from-slate-900 via-indigo-950/30 to-slate-900 p-8 md:p-12 rounded-3xl border border-indigo-500/10 shadow-2xl scroll-mt-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div
              className="flex items-center gap-4 p-4 rounded-xl bg-slate-950/60 border border-slate-900"
            >
              <span className="text-2xl bg-emerald-500/10 p-2.5 rounded-xl text-emerald-400">💬</span>
              <div>
                <p className="text-xs text-slate-500 font-medium">คุยผ่าน Line</p>
